...
namespace ConsolePasswordInput
{
	...
	class ConsolePasswordInput
	{
        ...
        [DllImport("Kernel32.DLL", EntryPoint = "WriteConsoleW", CallingConvention = CallingConvention.StdCall, ThrowOnUnmappableChar = true, CharSet = CharSet.Unicode)]
        ...
        [DllImport("Kernel32.DLL", EntryPoint = "FlushConsoleInputBuffer", CallingConvention = CallingConvention.StdCall, ThrowOnUnmappableChar = true, CharSet = CharSet.Unicode)]
		public static extern bool FlushConsoleInputBuffer(IntPtr hConsoleInput);

		// Not used in this application but declared here for possible future use.
		[DllImport("Kernel32.DLL", EntryPoint="WriteConsoleOutputCharacterW", CallingConvention=CallingConvention.StdCall,ThrowOnUnmappableChar=true,CharSet=CharSet.Unicode)]

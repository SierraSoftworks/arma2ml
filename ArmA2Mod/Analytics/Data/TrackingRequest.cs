...
namespace SierraLib.Analytics.Common.Data
{
	/// <summary>
	...
	public class TrackingRequest
	{
		...
		public string TrackingGifURL
		{
			get
			{
                ...
                // utmwv=4.6.5
                // &utmn=488134812
                // &utmhn=facebook.com&utmcs=UTF-8
                // &utmsr=1024x576
                // &utmsc=24-bit
                // &utmul=en-gb
                // &utmje=0
                // &utmfl=10.0%20r42
                // &utmdt=Facebook%20Contact%20Us
                // &utmhid=700048481
                // &utmr=-
                // &utmp=%2Fwebdigi%2Fcontact
                // &utmac=UA-3659733-5
                // &utmcc=__utma%3D155417661.474914265.1263033522.1265456497.1265464692.6%3B%2B__utmz%3D155417661.1263033522.1.1.utmcsr%3D(direct)%7Cutmccn%3D(direct)%7Cutmcmd%3D(none)%3B
				...
				List<KeyValuePair<string, string>> paramList = new List<KeyValuePair<string, string>>
				{
					...
					new KeyValuePair<string,string>("utmsr", SystemInformation.PrimaryMonitorSize.Width + "x" + SystemInformation.PrimaryMonitorSize.Height),										// Screen Resolution
					new KeyValuePair<string,string>("utmsc",new Microsoft.VisualBasic.Devices.Computer().Screen.BitsPerPixel + "-bit"),										// Screen Resolution
					new KeyValuePair<string,string>("utmul", Thread.CurrentThread.CurrentCulture.ThreeLetterISOLanguageName),										// user language

...
namespace SierraLib.Analytics.Common.Data
{
	...
	public class GoogleEvent
	{
		...
		public void Validate()
		{
			...
			{
				throw new ArgumentException("'DomainName' is a required field");
			}
			if (String.IsNullOrEmpty(Category))
			{
				throw new ArgumentException("'Category' is a required field");
			}
			if (String.IsNullOrEmpty(Action))
			{
				throw new ArgumentException("'Action' is a required field");
			}
			if (String.IsNullOrEmpty(Label))
			{
				throw new ArgumentException("'Label' is a required field");
			}
